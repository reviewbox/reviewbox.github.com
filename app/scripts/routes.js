 ...
 */
  ...
  .config(['$routeProvider', function($routeProvider) {
    $routeProvider
      ...
      .whenAuthenticated('/gskb', {
        templateUrl: 'views/gskb.html',
        controller: 'GskbCtrl'
      })
      .when('/cook', {
      ...
      .when('/cook/recipes',{templateUrl: 'views/recipes.html', controller:'RecipesCtrl'})
      .when('/cook/recipes/:id', {
        templateUrl: 'views/recipecontent.html',
        controller: 'RecipecontentCtrl'
      })
      .when('/cook/alliences',{templateUrl: 'views/alliences.html', controller:'ReadarticleCtrl'})
      .when('/cook/places', {templateUrl: 'views/places.html', controller:'PlacesCtrl'})
      ...
      .when('/cook/cookbang', {
        templateUrl: 'views/cookbang.html',
        controller: 'CookbangCtrl'
      })
      ...
      .when('/editor-test', {
        templateUrl: 'views/editor-test.html',
        controller: 'EditorTestCtrl'
      })
      .when('/wordBox', {
        templateUrl: 'views/wordbox.html',
        controller: 'WordboxCtrl'
      })
      .when('/quote', {
      ...
      .when('/part-tool', {
        templateUrl: 'views/part-tool.html',
        controller: 'PartToolCtrl'
      })
      .when('/selectProduct', {
      ...
      .when('/prd-detail/:id', {
        templateUrl: 'views/prd-detail.html',
        controller: 'PrdDetailCtrl'
      })
      .when('/boxes', {
   ...
   */
  .run(['$rootScope', '$location', 'Auth', 'SECURED_ROUTES', 'loginRedirectPath', 'firebaseAuth',
    function($rootScope, $location, Auth, SECURED_ROUTES, loginRedirectPath, firebaseAuth) {
      ...
      function check(user) {
        if( !user && authRequired($location.path()) ) {
          ...
          if (user) {
            var presences = firebaseAuth.runCheckPresenceStatus(user);
          }
        }
      }
